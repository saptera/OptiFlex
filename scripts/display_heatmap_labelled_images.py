...
from OptiFlex.utils.disp_func import img_hml_plt
...
""" Parameters:
        ...
        lbl_path: {STR} Folder with corresponding HeatMap label files, use the same as [img_path] if left blank.
...
while True:
    ...
    frm = img_lst[i]
    lbl = os.path.splitext(frm)[0] + ".pkl"
    title = frm[-9:-4]
    img, _ = img_hml_plt(img_path + frm, lbl_path + lbl, joint=None, color_list=color_list)
